...
description: "Use this agent when drafting, refining, or debugging the cold outreach email copy generated by pipeline/agents/sales_agent.py -- prompt design for the Hugging Face Mistral-7B-Instruct-v0.2 call, the deterministic fallback template, and output parsing."
