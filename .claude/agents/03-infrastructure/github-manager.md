...
When invoked:
1. Read `pipeline/utils/github_api.py` (`create_repo`, `push_files`, `create_repo_with_files`, `make_repo_name`, `invite_collaborator`, `remove_collaborator`, `get_authenticated_username`) and `pipeline/main.py`'s `_handle_transfer`.
