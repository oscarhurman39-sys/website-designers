...
def push_files(repo: Repository, files: dict[str, str], commit_message: str = "Initial preview site") -> None:
    ...
    If a file already exists (422, e.g. a retried push after a partial
    failure), update it in place instead of raising -- an existing file
    must never permanently brick the lead by crashing this loop partway
    through.
    """
